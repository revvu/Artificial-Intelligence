...
def evaluate_pos(brd,tkn):
    ...
    value += 0*x_squares_heuristic(brd, tkn)
    value += 1*c_squares_heuristic(brd, tkn)
    value += 1*wedged_edge_heuristic(brd, tkn)
    value += 0*safe_edge_heuristic(brd,tkn)
    value += 0*stable_mv_heuristic(brd,tkn)
