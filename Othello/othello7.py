...
def corner_heuristic(brd,tkn):
    return 25.0*(count_corner(brd,tkn)-count_corner(brd,oppose(tkn)))
...
def evaluate_pos(brd,tkn):
    ...
    value = 1000*corner_heuristic(brd,tkn)
    value += 100*x_squares_heuristic(brd, tkn)
    value += 10*stable_mv_heuristic(brd,tkn)
