...
def find_best_move(othello_board, token, lst_of_moves):
    ...
    for move in lst_of_moves:
        ...
        move_value += positional_value_dict[move]+stable_disc_count*100\
                     -find_opposing_mobility(othello_board, token, move, lst_of_moves)*2 - total_flip*10 - total_frontier*10
